...
func newFile(db *gorm.DB, opts ...gen.DOOption) file {
	...
	_file.DateCreate = field.NewTime(tableName, "date_create")
	_file.DateLastChange = field.NewTime(tableName, "date_last_change")
	_file.CreaterID = field.NewInt64(tableName, "creater_id")
	_file.ChangerID = field.NewInt64(tableName, "changer_id")
	_file.Title = field.NewString(tableName, "title")
	_file.ObjID = field.NewInt64(tableName, "obj_id")
	_file.ObjType = field.NewString(tableName, "obj_type")
	_file.FullPath = field.NewString(tableName, "full_path")
	...
	_file.ThumbnailURL = field.NewString(tableName, "thumbnail_url")
	_file.URL = field.NewString(tableName, "url")
	_file.IsArchive = field.NewBool(tableName, "is_archive")
...
func (f *file) updateTableName(table string) *file {
	...
	f.ObjID = field.NewInt64(table, "obj_id")
	f.ObjType = field.NewString(table, "obj_type")
	f.FullPath = field.NewString(table, "full_path")
	...
	f.ThumbnailURL = field.NewString(table, "thumbnail_url")
...
func (f *file) fillFieldMap() {
	...
	f.fieldMap["obj_id"] = f.ObjID
	f.fieldMap["obj_type"] = f.ObjType
	f.fieldMap["full_path"] = f.FullPath
	f.fieldMap["file_name"] = f.FileName
	f.fieldMap["extension"] = f.Extension
	f.fieldMap["size"] = f.Size
	f.fieldMap["file_type"] = f.FileType
	f.fieldMap["thumbnail_url"] = f.ThumbnailURL
