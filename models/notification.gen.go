...
func newNotification(db *gorm.DB, opts ...gen.DOOption) notification {
	...
	_notification.DateCreate = field.NewTime(tableName, "date_create")
	_notification.ProjectID = field.NewInt32(tableName, "project_id")
	_notification.NotiType = field.NewString(tableName, "noti_type")
	_notification.Title = field.NewString(tableName, "title")
	_notification.Note = field.NewString(tableName, "note")
	_notification.ObjID = field.NewInt64(tableName, "obj_id")
	_notification.ObjType = field.NewString(tableName, "obj_type")
	_notification.JSON = field.NewString(tableName, "json")
	_notification.Idglm = field.NewInt64(tableName, "idglm")
	_notification.IsReadNoti = field.NewBool(tableName, "is_read_noti")
	_notification.ExtID = field.NewInt64(tableName, "ext_id")
...
func (n *notification) updateTableName(table string) *notification {
	...
	n.DateCreate = field.NewTime(table, "date_create")
	n.ProjectID = field.NewInt32(table, "project_id")
	n.NotiType = field.NewString(table, "noti_type")
	n.Title = field.NewString(table, "title")
	n.Note = field.NewString(table, "note")
	n.ObjID = field.NewInt64(table, "obj_id")
	n.ObjType = field.NewString(table, "obj_type")
	n.JSON = field.NewString(table, "json")
	n.Idglm = field.NewInt64(table, "idglm")
	n.IsReadNoti = field.NewBool(table, "is_read_noti")
	n.ExtID = field.NewInt64(table, "ext_id")
...
func (n *notification) fillFieldMap() {
	...
	n.fieldMap["id"] = n.ID
	n.fieldMap["date_create"] = n.DateCreate
	n.fieldMap["project_id"] = n.ProjectID
	n.fieldMap["noti_type"] = n.NotiType
	n.fieldMap["title"] = n.Title
	n.fieldMap["note"] = n.Note
	n.fieldMap["obj_id"] = n.ObjID
	n.fieldMap["obj_type"] = n.ObjType
	n.fieldMap["json"] = n.JSON
	n.fieldMap["idglm"] = n.Idglm
	n.fieldMap["is_read_noti"] = n.IsReadNoti
	n.fieldMap["ext_id"] = n.ExtID
}
