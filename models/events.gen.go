...
func newEvent(db *gorm.DB, opts ...gen.DOOption) event {
	...
	_event.ObjID = field.NewInt32(tableName, "obj_id")
	_event.EventTypeTc = field.NewString(tableName, "event_type_tc")
	_event.DateCreate = field.NewTime(tableName, "date_create")
	_event.DoneDate = field.NewTime(tableName, "done_date")
	_event.Value = field.NewString(tableName, "value")
...
func (e *event) updateTableName(table string) *event {
	...
	e.EventTypeTc = field.NewString(table, "event_type_tc")
	e.DateCreate = field.NewTime(table, "date_create")
	e.DoneDate = field.NewTime(table, "done_date")
...
func (e *event) fillFieldMap() {
	...
	e.fieldMap["event_type_tc"] = e.EventTypeTc
	e.fieldMap["date_create"] = e.DateCreate
	e.fieldMap["done_date"] = e.DoneDate
