...
func newSetting(db *gorm.DB, opts ...gen.DOOption) setting {
	...
	_setting.DateCreate = field.NewTime(tableName, "date_create")
	_setting.DateLastChange = field.NewTime(tableName, "date_last_change")
	_setting.CreaterID = field.NewInt64(tableName, "creater_id")
	_setting.ChangerID = field.NewInt64(tableName, "changer_id")
...
func (s *setting) updateTableName(table string) *setting {
	...
	s.DateCreate = field.NewTime(table, "date_create")
	s.DateLastChange = field.NewTime(table, "date_last_change")
	s.CreaterID = field.NewInt64(table, "creater_id")
	s.ChangerID = field.NewInt64(table, "changer_id")
...
func (s *setting) fillFieldMap() {
	...
	s.fieldMap["date_create"] = s.DateCreate
	s.fieldMap["date_last_change"] = s.DateLastChange
	s.fieldMap["creater_id"] = s.CreaterID
	s.fieldMap["changer_id"] = s.ChangerID
